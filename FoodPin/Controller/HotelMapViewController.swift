...
class HotelMapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        geoCoder.geocodeAddressString(hotel.location, completionHandler: { placemarks, error in
            ...
            if let placemarks = placemarks {
                ...
                annotation.subtitle = self.hotel.website
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        leftIconView.image = UIImage(named: hotel.image)
